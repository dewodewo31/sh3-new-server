<nav class="custom-scroll flex-1 space-y-6 overflow-y-auto px-3 py-5" aria-label="Navigasi utama">
    <div class="space-y-1">
        ...
        <a href="{{ route('admin.memberships.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.memberships.*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
        ...
        <a href="{{ route('admin.membership-plans.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.membership-plans.*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941"/></svg>
            Plan Membership
        </a>
        @endcan
    ...
    <div class="space-y-1">
        ...
        <a href="{{ route('admin.attendance.report') }}"
           class="sidebar-link {{ request()->routeIs('admin.attendance.report', 'admin.attendance.by-event') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            Attendance
        </a>

        <a href="{{ route('admin.attendance.scan') }}"
           class="sidebar-link {{ request()->routeIs('admin.attendance.scan') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
